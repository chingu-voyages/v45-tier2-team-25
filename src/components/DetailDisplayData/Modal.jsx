                  ...
                  <div className="strike-detail">
                    <table className="table-auto">
                      ...
                      <tr>
                        <td>Name Type: </td>
                        <span className="value">
                          <td>{selectedItem.nametype}</td>
                        </span>
                      </tr>
                      <tr>
                        <td>Rec Class: </td>
                        <span className="value">
                          <td>{selectedItem.recclass}</td>
                        </span>
                      </tr>
                      <tr>
                        <td>Mass: </td>
                        <span className="value">
                          <td>{selectedItem.mass}</td>
                        </span>
                      </tr>
                      <tr>
                        <td>Fall: </td>
                        <span className="value">
                          <td>{selectedItem.fall}</td>
                        </span>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Reclat: </td>
                        <span className="value">
                          <td>{selectedItem.reclat}</td>
                        </span>
                      </tr>
                      <tr>
                        <td>Reclong: </td>
                        <span className="value">
                          <td>{selectedItem.reclong}</td>
                        </span>
                      </tr>
                      <tr>
                        <td>GeoLocation: </td>
                        <span className="value">
                          <td>
                            {selectedItem.geolocation && (
                              <div>
                                Latitude: {selectedItem.geolocation.latitude},
                                Longitude: {selectedItem.geolocation.longitude}
                              </div>
                            )}
                          </td>
                        </span>
